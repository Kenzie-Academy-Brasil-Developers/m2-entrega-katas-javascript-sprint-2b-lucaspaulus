# Entrega: Refatorando funções ES5
...
# Envio
Faça o push do código para o seu repositório GitHub. No Canvas, por favor, envie a url do seu repositório. Não esqueça de colocar o repositório como internal. **Nesta entrega, não é necessário implementar o pages.**
